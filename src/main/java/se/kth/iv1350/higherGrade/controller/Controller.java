package se.kth.iv1350.higherGrade.controller;

import java.lang.String;
import java.util.ArrayList;

import se.kth.iv1350.higherGrade.discount.*;
import se.kth.iv1350.higherGrade.dto.*;
import se.kth.iv1350.higherGrade.integration.*;
import se.kth.iv1350.higherGrade.model.*;
    ...
    public SaleInfoDTO identifyItem(String identifier) throws ItemNotFoundException, ServerDownException{
        if(sale.checkForDuplicate(identifier)){
            ...
            try {
                ...
                System.out.println("[FOR DEVELOPER]" + exception.getMessage());
                throw exception;
            }
        }
    }
